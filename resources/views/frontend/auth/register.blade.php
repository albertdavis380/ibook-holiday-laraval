                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.register')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="mobile" id="mobile" class="form-control" value="{{ old('mobile') }}" placeholder="{{ __('Mobile') }}" maxlength="20" required />
                                </div>
                            </div>

                            <div class="form-group row">
                            <label for="cv" class="col-md-4 col-form-label text-md-right">@lang('CV')</label>
